...
const Table = ({ data, setData, updateArray, setUpdateArray, arrayIndex, setArrayIndex }) => {
  let userId = sessionStorage.getItem("id");

  const del = async (id) => {
    try {
      await axios.delete(`${process.env.REACT_APP_VERCEL_BACKEND_URL}/api/todo/delete/${id}`, {
        data: { id: userId }
      });
